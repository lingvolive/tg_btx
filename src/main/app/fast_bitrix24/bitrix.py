...
class BitrixAsync:
    ...
    @log
    async def get_all_with_batch(self, method: str, params: dict = None) -> Union[list, dict]:
        """
        Получить полный список сущностей по запросу `method`.
        ...
        return await self.srh.run_async(GetAllUserRequestWithBatch(self, method, params).run())
